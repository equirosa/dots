...
_G.packer_plugins = {
  ["completion-nvim"] = {
    loaded = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/start/completion-nvim"
  },
  ["gruvbox-material"] = {
    loaded = true,
  ...
  ["nlua.nvim"] = {
    loaded = false,
    needs_bufread = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/opt/nlua.nvim"
  },
  ["nvim-lspconfig"] = {
    loaded = true,
  ...
  ["packer.nvim"] = {
    loaded = false,
    needs_bufread = false,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/opt/packer.nvim"
  },
  ["plenary.nvim"] = {
    loaded = true,
  ...
  ["vim-nix"] = {
    loaded = false,
    needs_bufread = true,
    path = "/home/eduardo/.local/share/nvim/site/pack/packer/opt/vim-nix"
  }
}
...
time("Sourcing ftdetect script at: /home/eduardo/.local/share/nvim/site/pack/packer/opt/vim-nix/ftdetect/nix.vim", true)
vim.cmd [[source /home/eduardo/.local/share/nvim/site/pack/packer/opt/vim-nix/ftdetect/nix.vim]]
time("Sourcing ftdetect script at: /home/eduardo/.local/share/nvim/site/pack/packer/opt/vim-nix/ftdetect/nix.vim", false)
vim.cmd("augroup END")
